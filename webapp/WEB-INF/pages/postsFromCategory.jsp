...
<div class="row">
    ...
    <c:forEach items="${postsInCategory}" var="post">
    ...
    <div class="pagination">
        <ul class="pagination">
            <c:url value="/news/category/${categoryId}" var="prev">
            ...
            <c:forEach begin="1" end="${maxPages}" step="1" varStatus="i">
                <c:choose>
                    <c:when test="${page == i.index}">
                        <c:url value="/news/category/${categoryId}" var="url"/>
            ...
            <c:url value="/news/category/${categoryId}" var="next">
                <c:param name="page" value="${page + 1}"/>
            </c:url>
